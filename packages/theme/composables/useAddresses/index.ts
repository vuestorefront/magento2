...
export function useAddresses(): UseAddressesInterface {
  ...
  const save = withLoading(async (saveParams: ComposableFunctionArgs<UseAddressesParamsInput>) => {
  ...
  const update = withLoading(async (updateParams: ComposableFunctionArgs<UseAddressesParamsInput>) => {
  ...
  const remove = withLoading(async (removeParams: ComposableFunctionArgs<UseAddressesParamsInput>) => {
