...
export default defineComponent({
  components: {
    ...
    HeaderLogo: () => import(/* webpackPrefetch: true */'~/components/HeaderLogo.vue'),
    HeaderNavigationItem: () => import(/* webpackPrefetch: true */'~/components/Header/Navigation/HeaderNavigationItem.vue'),
