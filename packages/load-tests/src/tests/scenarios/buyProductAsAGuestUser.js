...
export default function main() {
  ...
  group(`Buy product as a guest user - page ${BASE_URL}`, () => {
    ...
    group("Select the a category", () => {
      res = http.post(`${BASE_URL}/api/magento/route`, '["/women.html",null]', {
        headers,
      });
      executeCommonChecks(res);
    ...
    group("configure the product", () => {
      ...
      res = http.post(`${BASE_URL}/api/magento/upsellProducts`, '[{"filter":{"sku":{"eq":"WSH11"}}},null]', {
        headers,
      });
      executeCommonChecks(res);

      res = http.post(`${BASE_URL}/api/magento/relatedProduct`, '[{"filter":{"sku":{"eq":"WSH11"}}},null]', {
        headers,
      });
      executeCommonChecks(res);

      res = http.post(`${BASE_URL}/api/magento/productReviewRatingsMetadata`, "[null]", {
        headers,
      });
      executeCommonChecks(res);
      sleep(1.1);
    ...
    group("Add product to the cart", () => {
      res = http.post(`${BASE_URL}/api/magento/createEmptyCart`, "[]", {
        headers,
      });
      executeCommonChecks(res);

      [vars.cart_id] = jsonpath.query(res.json(), "$.data.createEmptyCart");

      res = http.post(`${BASE_URL}/api/magento/cart`, `["${vars.cart_id}"]`, {
        headers,
      });
      executeCommonChecks(res);
    ...
    group("Go through the checkout", () => {
      ...
      res = http.post(`${BASE_URL}/api/magento/setGuestEmailOnCart`, `[{"email":"john.loadtest@gmail.com","cart_id":"${vars.cart_id}"},null]`, {
        headers,
      });
      executeCommonChecks(res);
      ...
      res = http.post(`${BASE_URL}/api/magento/countries`, "[]", {
        headers,
      });
      executeCommonChecks(res);
      sleep(2.2);

      res = http.post(`${BASE_URL}/api/magento/country`, '["PL",null]', {
        headers,
      });
      executeCommonChecks(res);
      sleep(3.9);
      ...
      res = http.post(`${BASE_URL}/api/magento/getAvailablePaymentMethods`, `[{"cartId":"${vars.cart_id}"},null]`, {
        headers,
      });
      executeCommonChecks(res);
      sleep(1.2);

      res = http.post(`${BASE_URL}/api/magento/setPaymentMethodOnCart`, `[{"cart_id":"${vars.cart_id}","payment_method":{"code":"checkmo"}},null]`, {
        headers,
      });
      executeCommonChecks(res);
      sleep(1.5);
    ...
    group("Place the order", () => {
      res = http.post(`${BASE_URL}/api/magento/placeOrder`, `[{"cart_id":"${vars.cart_id}"},null]`, {
        headers,
      });
      executeCommonChecks(res);
    });
