...
const OPTIONS_MOCK = { clientConfig: {}, customHeaders: {}, customQuery: {} } as MethodOptions<CustomQuery<'createProductReview'>>;
...
describe(describeGroup('createProductReview'), () => {
  ...
  it('makes a call to API Middleware with proper params and options', async () => {
    ...
    expect(client.post).toBeCalledWith(
      'createProductReview', [expect.objectContaining(PARAMS_MOCK), {}], {}
    );
  });
