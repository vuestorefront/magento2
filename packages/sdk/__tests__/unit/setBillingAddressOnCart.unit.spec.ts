...
const OPTIONS_MOCK = { clientConfig: {}, customHeaders: {}, customQuery: {} } as MethodOptions<CustomQuery<'setBillingAddressOnCart'>>;
...
describe(describeGroup('setBillingAddressOnCart'), () => {
  ...
  it('makes a call to API Middleware with proper params and options', async () => {
    ...
    expect(client.post).toBeCalledWith(
      'setBillingAddressOnCart', [expect.objectContaining(PARAMS_MOCK), {}, {}], {}
    );
  });
