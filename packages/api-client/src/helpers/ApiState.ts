...
export class ApiState {
  ...
  constructor(storage: Storage, websites: Record<string, Website>, defaultStore: string) {
    ...
    this.cartId = storage.getItem(this.CART_ID);
    this.customerToken = storage.getItem(this.CUSTOMER_TOKEN);
    this.storeCode = storage.getItem(this.STORE) || defaultStore;
  ...
  setCartId(cartId: string|null): void {
    this.cartId = cartId;
    this.storage.setItem(this.CART_ID, cartId);
  }
  ...
  setCustomerToken(customerToken: string|null): void {
    ...
    this.storage.setItem(this.CUSTOMER_TOKEN, customerToken);
  }
  ...
  setStoreCode(storeCode: string): void {
    ...
    this.storage.setItem(this.STORE, storeCode);
  }
