...
[Home](./index.md) &gt; [@vue-storefront/magento-api](./magento-api.md) &gt; [CustomerDataFragment](./magento-api.customerdatafragment.md)

## CustomerDataFragment type

<b>Signature:</b>

```typescript
export declare type CustomerDataFragment = {
