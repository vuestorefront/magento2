...
[Home](./index.md) &gt; [@vue-storefront/magento-api](./magento-api.md) &gt; [AddBundleProductsToCartMutation](./magento-api.addbundleproductstocartmutation.md)

## AddBundleProductsToCartMutation type

<b>Signature:</b>

```typescript
export declare type AddBundleProductsToCartMutation = {
    addBundleProductsToCart?: Maybe<{
        cart: {
            id: string;
            email?: Maybe<string>;
            is_virtual: boolean;
