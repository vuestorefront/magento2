...
[Home](./index.md) &gt; [@vue-storefront/magento-api](./magento-api.md) &gt; [CompleteCartDataFragment](./magento-api.completecartdatafragment.md)

## CompleteCartDataFragment type

<b>Signature:</b>

```typescript
export declare type CompleteCartDataFragment = {
    id: string;
    email?: Maybe<string>;
    is_virtual: boolean;
