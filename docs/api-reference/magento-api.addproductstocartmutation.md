...
[Home](./index.md) &gt; [@vue-storefront/magento-api](./magento-api.md) &gt; [AddProductsToCartMutation](./magento-api.addproductstocartmutation.md)

## AddProductsToCartMutation type

<b>Signature:</b>

```typescript
export declare type AddProductsToCartMutation = {
    addProductsToCart?: Maybe<{
        cart: {
            id: string;
            email?: Maybe<string>;
            is_virtual: boolean;
